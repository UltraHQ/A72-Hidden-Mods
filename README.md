...
> Note: The module will check, whether all requirements are met (Android version, device, current security patch). If something is not compatible, the installation will fail for your safety. You can overwrite this behaviour by deleting customize.sh in the .zip of the module. However this is not recommended and at your own risk. 
